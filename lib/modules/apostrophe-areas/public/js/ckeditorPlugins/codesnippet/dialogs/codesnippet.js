...
;(function() {
  CKEDITOR.dialog.add('codeSnippet', function(editor) {
    ...
    for (snippetLangId in snippetLangs) langSelectItems.push([snippetLangs[snippetLangId], snippetLangId])
          ...
          elements: [
            {
              ...
              setup: function(widget) {
                if (widget.ready && widget.data.lang) this.setValue(widget.data.lang)
