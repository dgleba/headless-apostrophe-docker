...
const handleHrefClick = () => {
  ...
  const click = (ev, el) => {
    ...
    // when link to other page type (eg: link in "intro" to "career"), update "appeated" page
...
const handleTransitionEnd = (number, animate) => {
  return new Promise((resolve, reject) => {
    if (animate !== 'menu') resolve()
      ...
      const mainNav = document.querySelector('nav.at_menu')
      mainNav.classList.toggle('at_menu--appear')
