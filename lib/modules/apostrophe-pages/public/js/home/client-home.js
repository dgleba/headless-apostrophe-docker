...
const enterHome = () => {
  ...
  content.style.top = `${window.innerHeight - content.clientHeight}px`
  ...
  tl
    ...
    .to(text_line_2, 1, { text: 'skill: [ "Agile", "Dev", "Trainer" ]', ease: Linear.easeNone }, '-=1')
...
export { animateHome, enterHome, leaveHome }
